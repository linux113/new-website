-- ============================================================
--  SRIYAAN METALS — RESET + full import
--  FILE VERSION: v3 (2026-09-05) — hex-encoded text, immune to escape processing
--
--  *** THIS DELETES EVERYTHING IN THE DATABASE FIRST ***
--
--  Use this when the database already contains tables — including a
--  half-finished import (#1050 Table already exists).
--  Back up first if you have real data: phpMyAdmin -> Export.
--
...
-- ============================================================
--  RESET — remove any existing tables
-- ============================================================

DROP TABLE IF EXISTS `VisitorPresence`;
DROP TABLE IF EXISTS `PageView`;
DROP TABLE IF EXISTS `NavigationItem`;
DROP TABLE IF EXISTS `SocialLink`;
DROP TABLE IF EXISTS `WebsiteSetting`;
DROP TABLE IF EXISTS `VendorRequest`;
DROP TABLE IF EXISTS `ContactMessage`;
DROP TABLE IF EXISTS `ProductEnquiry`;
DROP TABLE IF EXISTS `ImportExportCapability`;
DROP TABLE IF EXISTS `GlobalCountry`;
DROP TABLE IF EXISTS `Testimonial`;
DROP TABLE IF EXISTS `Customer`;
DROP TABLE IF EXISTS `Certification`;
DROP TABLE IF EXISTS `InfrastructureItem`;
DROP TABLE IF EXISTS `Industry`;
DROP TABLE IF EXISTS `Capability`;
DROP TABLE IF EXISTS `CompanyPage`;
