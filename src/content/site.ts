...
export const MAIN_NAV: NavItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    href: "/products",
    children: [
      { index: "01", label: "Bolts, Studs & Screws", href: "/products/category/bolts-studs-screws", meta: "Hex bolts, studs & threaded rods" },
      { index: "02", label: "Nuts & Washers", href: "/products/category/nuts-washers", meta: "Hex, slotted, coupling & plain" },
      { index: "03", label: "Anchors & Foundation Bolts", href: "/products/category/anchors-foundation", meta: "Anchor & J-type foundation bolts" },
      { index: "04", label: "Rivets & Inserts", href: "/products/category/rivets-inserts", meta: "Rivet nuts & threaded inserts" },
      { index: "05", label: "Pipe Fittings & Flanges", href: "/products/category/pipe-fittings-flanges", meta: "BW / SW / threaded, forged flanges" },
      { index: "06", label: "Carbon Steel Pipes", href: "/products/category/carbon-steel-pipes", meta: "Dimensions per ASTM B36.10" },
    ],
  },
...
export const FOOTER_COLUMNS: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Carbon Steel Pipes", href: "/products/category/carbon-steel-pipes" },
